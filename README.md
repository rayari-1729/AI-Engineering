...
<p align="center">
    <p align="center">
    <a target="_blank" href="https://github.com/rayari-1729/AI-Engineering">
    </a>
    </p>
...
<h4 align="center">
    <a href="https://github.com/rayari-1729/AI-Engineering" target="_blank">
        <img src="https://img.shields.io/badge/contributions-welcome-brightgreen.svg" alt="Contributions Welcome">
    </a>
    <a href="https://github.com/rayari-1729/AI-Engineering/blob/main/LICENSE">
...
| Name | Description | When to Use | Link |
|------|-------------|-------------|------|
| Promptfoo | Evaluation and red-teaming CLI for LLM outputs | When you need to systematically test prompts and models before production: provides automated testing, side-by-side comparisons, and vulnerability scanning to catch regressions. | [Github repo](https://github.com/promptfoo/promptfoo) |
| LLM Guard | Comprehensive security toolkit for LLM applications | When you need to sanitize and secure LLM inputs and outputs: offers real-time scanners for prompt injection, PII redaction, toxicity, and jailbreak attempts. | [Github repo](https://github.com/protectai/llm-guard) | 
| NeMo Guardrails | Programmable guardrails for conversational AI | When you need strict, programmable control over your LLM's dialogue: allows you to define factual, topical, and safety rails to prevent hallucinations and off-topic responses. | [Guthub repo](https://github.com/NVIDIA/NeMo-Guardrails) | 
...
## Support
- [DM the creator on LinkedIn 💭](https://www.linkedin.com/in/aritra-roy1729/)
- [GitHub Issues 🐛](https://github.com/rayari-1729/AI-Engineering/issues)

## Star History
You can **star ⭐️ this repo** to stay updated on the latest AI Engineering.
